...
The original data (from the UCI repository) (http://www.ics.uci.edu/~mlearn/MLSummary.html) has 205 instances described by 26 attributes :
- 15 continuous
- 1 integer
- 10 nominal
...
Changed the original data in the following way :
